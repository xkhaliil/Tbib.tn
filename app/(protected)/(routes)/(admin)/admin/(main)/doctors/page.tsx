...
export default async function AdminDoctorsDashboard() {
  const HealthCareProvidersCount = await getHealthcareCentersCount();
  const HealthCareProvidersTotalUsers = await getHealthcareProviderByMonth();
  return (
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-4">
            <Card className="col-span-3 bg-muted/40">
              ...
              <CardContent className="pl-2">
                <AdminDoctorChartDashboard
                  users={HealthCareProvidersTotalUsers}
                />
              </CardContent>
            </Card>
            ...
            <div className="rounded-lgp-4 col-span-2 flex items-center justify-center lg:col-span-1 ">
              <AdminStatsCard
                ...
                value={HealthCareProvidersCount}
                icon={FaUserDoctor}
