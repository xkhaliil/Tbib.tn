...
interface HealthcareProviderCardForHealthcareCenterProps {
...
export function HealthcareProviderCardForHealthcareCenter({
  healthcareProvider,
}: HealthcareProviderCardForHealthcareCenterProps) {
                ...
                onClick={() => {
                  ...
                  router.push(
                    `/book/healthcare-providers/${healthcareProvider.id}/${format(
                      day,
                      "yyyy-MM-dd",
                    )}?hc=${healthcareProvider.healthCareCenterId}`,
                  );
                }}
                className={cn(
