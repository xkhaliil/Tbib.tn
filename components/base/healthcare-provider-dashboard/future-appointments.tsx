  ...
  return appointments?.map((appointment) => (
    <div
      ...
      className={cn("flex items-center border-b border-l-[6px] p-4", {
        "border-l-warning": appointment?.status === AppointmentStatus.PENDING,
        "border-l-success": appointment.status === AppointmentStatus.UPCOMING,
        "border-l-primary": appointment.status === AppointmentStatus.CONFIRMED,
      })}
    >
