...
import { HealthcareCentersDataTableActions } from "./actions";
...
const columnHelper = createColumnHelper<HealthcareCenter>();
export const columns = [
  ...
  columnHelper.display({
    ...
    cell: ({ row }) => {
      return (
        <HealthcareCentersDataTableActions healthcareCenter={row.original} />
      );
    },
  }),
];
